...
class TestLgtmImageControllerExec:
    """LgtmImageController.exec() のテスト.
...
class TestLgtmImageControllerExecRecentlyCreated:
    """LgtmImageController.exec_recently_created() のテスト.
